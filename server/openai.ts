...
export async function analyzeTechnicalIssue(userMessage: string, language: string = 'en-US'): Promise<TroubleshootingResponse> {
  ...
  try {
    ...
    return {
      ...
      response: result.response || "I understand you're having an issue. Please describe if it's related to camera connectivity, PLC disconnection, or runtime errors so I can provide the appropriate troubleshooting steps.",
...
export async function generateWelcomeMessage(language: string = 'en-US'): Promise<string> {
  const welcomeMessages = {
    'en-US': "Welcome to TECHASOFT Support! I'm here to help you with camera connectivity, PLC disconnection, runtime errors, and system maintenance. How can I assist you today?",
    'te-IN': "టెకాసాఫ్ట్ సపోర్ట్‌కు స్వాగతం! కెమెరా కనెక్టివిటీ, PLC డిస్‌కనెక్షన్, రన్‌టైమ్ ఎర్రర్స్ మరియు సిస్టమ్ మెయింటెనెన్స్‌తో మీకు సహాయం చేయడానికి నేను ఇక్కడ ఉన్నాను. ఈ రోజు నేను మీకు ఎలా సహాయం చేయగలను?",
    'ta-IN': "டெகாசாஃப்ட் ஆதரவுக்கு வரவேற்கிறோம்! கேமரா இணைப்பு, PLC துண்டிப்பு, இயக்க நேர பிழைகள் மற்றும் கணினி பராமரிப்பு ஆகியவற்றில் உங்களுக்கு உதவ நான் இங்கே இருக்கிறேன். இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்?",
    'hi-IN': "टेकासॉफ्ट सपोर्ट में आपका स्वागत है! मैं कैमरा कनेक्टिविटी, PLC डिस्कनेक्शन, रनटाइम एरर्स और सिस्टम मेंटेनेंस में आपकी मदद के लिए यहाँ हूँ। आज मैं आपकी कैसे सहायता कर सकता हूँ?",
    'kn-IN': "ಟೆಕಾಸಾಫ್ಟ್ ಬೆಂಬಲಕ್ಕೆ ಸ್ವಾಗತ! ಕ್ಯಾಮೆರಾ ಸಂಪರ್ಕ, PLC ಸಂಪರ್ಕ ಕಡಿತ, ರನ್‌ಟೈಮ್ ದೋಷಗಳು ಮತ್ತು ಸಿಸ್ಟಮ್ ನಿರ್ವಹಣೆಯಲ್ಲಿ ನಿಮಗೆ ಸಹಾಯ ಮಾಡಲು ನಾನು ಇಲ್ಲಿದ್ದೇನೆ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು?"
  };
