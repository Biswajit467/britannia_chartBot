...
export const troubleshootingData: TroubleshootingIssue[] = [
  {
    ...
    steps: [
      { id: 1, description: 'Go to the specific line (location) in the variant area where the camera setup is installed.' },
      { id: 2, description: 'Check the TECASOFT control panel and open it.' },
      { id: 3, description: 'Inside the control panel, locate the Ethernet switch.' },
      { id: 4, description: 'Observe the lights on the Ethernet switch: If all lights are blinking fast, it indicates proper connectivity. If lights are not blinking properly, this may signal a disconnection or fault.' },
      { id: 5, description: 'If abnormal blinking is noticed, unplug the Ethernet cables and re-plug them firmly.' },
      { id: 6, description: 'Cross-check each Ethernet connection to ensure every wire is properly and securely connected.' },
      { id: 7, description: 'Go to the AC room where the system is located.' },
      { id: 8, description: 'Open the Client Application on the system.' },
      { id: 9, description: 'Click the Refresh button inside the application.' },
      { id: 10, description: 'Click the Stop button, wait for a moment, and then click the Start button again to restart the camera services.' },
      { id: 11, description: 'If the issue still persists after restarting, please contact Developer Support for further assistance.' }
    ],
  ...
  },
  {
    ...
    steps: [
      { id: 1, description: 'Go to the specific line (location) in the variant area where the PLC setup is installed.' },
      { id: 2, description: 'Check the TECASOFT control panel and open it. Confirm whether the control panel is ON or OFF. If it is OFF, turn ON the control panel.' },
      { id: 3, description: 'Inside the control panel, locate the Ethernet switch.' },
      { id: 4, description: 'Observe the lights on the Ethernet switch: If all lights are blinking fast, it indicates proper connectivity. If lights are not blinking properly, it may signal a disconnection or fault.' },
      { id: 5, description: 'If abnormal blinking is noticed, unplug the Ethernet cables and re-plug them securely.' },
      { id: 6, description: 'Cross-check all Ethernet connections to ensure every wire is properly and securely connected.' },
      { id: 7, description: 'Go to the AC room where the main system is located. Cross-check whether the router\'s Ethernet wires are connected properly.' },
      { id: 8, description: 'Open the Client Application on the system.' },
      { id: 9, description: 'Click the Refresh button in the application.' },
      { id: 10, description: 'Click the Stop and OK button, wait for a moment, then click the Start and OK button to reinitialize the PLC connection.' },
      { id: 11, description: 'If the issue still persists after these steps, please contact Developer Support for further assistance.' }
    ],
  ...
  },
  {
    ...
    steps: [
      { id: 1, description: 'Go to the specific line (location) in the variant area where the PLC setup is installed.' },
      { id: 2, description: 'Check the TECASOFT control panel and open it. Confirm whether the control panel is ON or OFF. If it is OFF, turn ON the control panel.' },
      { id: 3, description: 'Go to the AC room where the main system is located.' },
      { id: 4, description: 'Open the Client Application on the system.' },
      { id: 5, description: 'Click the Refresh button in the application.' },
      { id: 6, description: 'Click the Stop and OK button, wait for a moment, then click the Start and OK button to restart the application.' },
      { id: 7, description: 'If the error still appears, restart the PC and then run the Client Application again.' },
      { id: 8, description: 'If the issue still persists after all the above steps, please contact Developer Support for further assistance.' }
    ],
